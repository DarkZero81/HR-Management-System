        ...
        <form method="GET" action="{{ route('my.requests.index') }}" class="mb-6" id="filterForm">
            <div class="employee-form-card rounded-2xl border border-slate-200 p-4 md:p-6 space-y-4">
                ...
                <div class="flex items-center gap-2 pt-1">
                    ...
                    <a href="{{ route('my.requests.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-500 rounded-xl text-sm font-semibold transition-all">
