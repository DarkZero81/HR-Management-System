        ...
        <div class="flex flex-1 items-center justify-center p-4">
            <div class="w-full max-w-md text-center">
                <div class="rounded-[32px] border border-slate-200/60 bg-white/70 p-8 glass-shell backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/60">
                    ...
                    <h1 class="mt-3 text-3xl font-bold text-slate-800">@yield('code', '404')</h1>
                    <h2 class="text-xl font-bold text-slate-800 dark:text-slate-200 mb-2">@yield('message', 'الصفحة غير موجودة')</h2>
