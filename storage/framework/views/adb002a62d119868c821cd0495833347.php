...
<div class="space-y-6">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="<?php echo e(route('shifts.create')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-500 to-teal-400 hover:from-blue-600 hover:to-teal-500 text-white rounded-xl font-semibold shadow-lg transition-all">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        ...
        <div class="employee-form-card rounded-2xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-slate-800"><?php echo e($stats['total_employees']); ?></p>
        ...
        <div class="employee-form-card rounded-2xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    ?>
                    <p class="text-2xl font-black text-slate-800"><?php echo e($avg > 0 ? round($avg, 1) : '-'); ?></p>
        ...
        <div class="employee-form-card rounded-2xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-slate-800"><?php echo e($stats['max_employees_shift'] > 0 ? $stats['max_employees_shift'] : '-'); ?></p>
                    <p class="text-xs text-slate-500"><?php echo e($stats['max_employees_shift_name'] ?? 'أكبر وردية موظفين'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="employee-form-card rounded-2xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-slate-800"><?php echo e($stats['empty_shifts']); ?></p>
        ...
        <div class="employee-form-card rounded-2xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-slate-800"><?php echo e($stats['overnight_shifts']); ?></p>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
        <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <form method="GET" action="<?php echo e(route('shifts.index')); ?>" class="relative">
                <i data-lucide="search" class="w-4 h-4 text-slate-400 absolute right-3 top-1/2 -translate-y-1/2"></i>
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="بحث عن وردية..."
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-6 py-4 text-slate-600"><?php echo e($loop->iteration + ($shifts->currentPage() - 1) * $shifts->perPage()); ?></td>
                            <td class="px-6 py-4 text-slate-800 font-semibold"><?php echo e($shift->shift_name); ?></td>
                            <td class="px-6 py-4 text-slate-600"><?php echo e($shift->start_time); ?></td>
                            <td class="px-6 py-4 text-slate-600"><?php echo e($shift->end_time); ?></td>
                            <td class="px-6 py-4 text-slate-600"><?php echo e($shift->grace_period_minutes); ?> دقيقة</td>
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-700">
                                    <?php echo e($shift->employees_count ?? 0); ?> موظف
                                </span>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <a href="<?php echo e(route('shifts.show', $shift)); ?>" class="p-2 rounded-xl bg-slate-100 hover:bg-blue-100 text-slate-600 hover:text-blue-600 transition-colors" title="عرض التفاصيل">
                                        <i data-lucide="eye" class="w-4 h-4"></i>
                                    </a>
                                    <a href="<?php echo e(route('shifts.edit', $shift)); ?>" class="p-2 rounded-xl bg-slate-100 hover:bg-blue-100 text-slate-600 hover:text-blue-600 transition-colors" title="تعديل">
                                        <i data-lucide="edit" class="w-4 h-4"></i>
                                    </a>
                                    <form action="<?php echo e(route('shifts.destroy', $shift)); ?>" method="POST" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف هذه الوردية؟<?php echo e($shift->employees_count > 0 ? ' سيؤدي إلى إزالة ارتباط ' . $shift->employees_count . ' موظف.' : ''); ?>')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Documents\Almonkez\employer_mange\resources\views/shifts/index.blade.php ENDPATH**/ ?>