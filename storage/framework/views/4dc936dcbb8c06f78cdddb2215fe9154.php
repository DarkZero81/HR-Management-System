    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <h1 class="text-3xl font-bold text-slate-800">أهلاً بك، <?php echo e(auth()->user()->name ?? 'المستخدم'); ?>!</h1>
        ...
        <?php if($viewMode === 'admin'): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6">
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-slate-800"><?php echo e($employeeCount); ?></p>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-slate-800"><?php echo e($todayAttendance); ?></p>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-slate-800"><?php echo e($lateMinutes); ?></p>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-slate-800"><?php echo e($pendingRequests); ?></p>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-100 p-6">
                    ...
                    <div class="space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $recentAttendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                class="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 px-4 py-3">
                                <span class="font-semibold text-slate-800"><?php echo e($log->employee?->first_name); ?>

                                    <?php echo e($log->employee?->last_name); ?></span>
                                <span class="rounded-lg bg-cyan-500/10 px-3 py-1 font-mono font-bold text-cyan-600 text-sm">
                                    <?php if($log->check_in): ?>
                                        <?php echo e(is_string($log->check_in) ? \Carbon\Carbon::parse($log->check_in)->format('h:i A') : $log->check_in->format('h:i A')); ?>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-100 p-6">
                    ...
                    <div class="space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $pendingTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                class="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 px-4 py-3">
                                <span class="font-semibold text-slate-800"><?php echo e($t->employee?->first_name); ?>

                                    <?php echo e($t->employee?->last_name); ?></span>
                                <span class="rounded-lg bg-amber-500/10 px-3 py-1 font-bold text-amber-600 text-sm">
                                    <?php if($t->transaction_type == 'leave'): ?>
                                        إجازة
                                    <?php elseif($t->transaction_type == 'permission'): ?>
                                        إذن غياب
                                    <?php elseif($t->transaction_type == 'penalty'): ?>
                                        جزاء مالي
                                    <?php elseif($t->transaction_type == 'promotion'): ?>
                                        ترقية
        ...
        <?php else: ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6">
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-slate-800"><?php echo e($employee->performance_score ?? 0); ?></p>
                    <?php if($departmentAvgScore): ?>
                        <p class="text-sm text-slate-500 mt-2">المتوسط القسمي: <?php echo e(number_format($departmentAvgScore, 2)); ?>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-2xl font-bold text-slate-800">
                        <?php echo e(number_format((float) ($employee?->base_salary ?? 0), 2)); ?></p>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-slate-800"><?php echo e($attendanceToday ?? 0); ?></p>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
                    ...
                    <p class="text-3xl font-bold text-slate-800"><?php echo e($vacationBalance); ?></p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-100 p-6">
                    ...
                    <div class="space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $recentAttendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                class="flex items-center justify-between rounded-xl border border-slate-100 bg-slate-50 px-4 py-3">
                                <span class="text-slate-600"><?php echo e($log->log_date?->format('Y-m-d') ?? '—'); ?></span>
                                <span class="font-semibold text-slate-800"><?php echo e($log->status); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    if (vacationCtx) {
                        new Chart(vacationCtx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    data: [<?php echo e(30 - ($vacationBalance ?? 0)); ?>,
                                        <?php echo e($vacationBalance ?? 0); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Documents\Almonkez\employer_mange\resources\views/dashboard.blade.php ENDPATH**/ ?>