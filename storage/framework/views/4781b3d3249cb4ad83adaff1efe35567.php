                ...
                <?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($hasAccess): ?>
                        <a href="<?php echo e(route($item['route'])); ?>"
                           class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs($item['route']) ? 'bg-gradient-to-l from-blue-600 to-teal-500 text-white shadow-lg' : 'text-slate-300 hover:bg-slate-700/50 hover:text-white'); ?>">
...
<?php /**PATH C:\Users\DELL\Documents\Almonkez\employer_mange\resources\views/layouts/app.blade.php ENDPATH**/ ?>