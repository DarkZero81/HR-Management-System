<?php $__env->startSection('title', 'تقويم الإجازات'); ?>
...
<div class="space-y-6">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('holidays.index')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-medium transition-all border border-white/10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="employee-form-card rounded-2xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-slate-800"><?php echo e($totalCount); ?></p>
        ...
        <div class="employee-form-card rounded-2xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-slate-800"><?php echo e($recurringCount); ?></p>
        ...
        <div class="employee-form-card rounded-2xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-slate-800"><?php echo e(\Carbon\Carbon::now()->format('Y')); ?></p>
            ...
            <div class="flex items-center gap-2">
                <select id="calendarMonth" class="select select-bordered select-sm text-lg font-bold text-slate-800 dark:text-slate-200 dark:bg-slate-800 dark:border-white/10">
                    <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($num); ?>" <?php echo e(\Carbon\Carbon::now()->month == $num ? 'selected' : ''); ?>><?php echo e($name); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Documents\Almonkez\employer_mange\resources\views/holidays/calendar.blade.php ENDPATH**/ ?>